...
void setup()
{
  ...
  song1 = minim.loadFile("MusicDownload/OOT Lost wood.mp3"); //albe to pass absulute path, file name & extension, and URL
}//End setup
//
void draw() {
...
void keyPressed()
{
  ...
  if ( key=='p' || key=='P' ) {
    if ( song1.isPlaying() ) {
      ...
      song1.play(14000); //Parameter is milli-seconds from start of audio file to start of playing
    }
